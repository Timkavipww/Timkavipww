...
🚀 Backend разработчик с фокусом на **масштабируемые API, микросервисы и Telegram Mini Apps**  
⚡ Создаю системы, которые **работают стабильно под нагрузкой и легко масштабируются**  
...
✔ Интеграции (Telegram, внешние API, платежи и др.)  
✔ Работа с очередями (Kafka, RabbitMQ)  
✔ Оптимизация производительности и запросов  
✔ Автоматизация процессов и написание скриптов  
